...
{
			echo "<h3><strong style='color: red; text-decoration:underline;'>DENNE SIDEN ER UTDATERT OG BLIR IKKE LENGRE VEDLIKEHOLDT! VENNLIGST BRUK DEN NYE <a href='../'>VERSJONEN.</a></strong></h3><br>";
			...
			$denne_siden="http://folk.uio.no/ibrahimh/ibv/index.php";
			include("sok.php");
			/*
